...
def removeBackground(img_path, save_path):
    ...
    # cv2.imwrite(save_path + "removeBackground.png", img)

    return img


if __name__ == '__main__':
    img_path = '/home/aether/Desktop/Medical Image Segmentation/lung_unet_model/Lung_CT/test/images/VESSEL12_20_png/VESSEL12_20-slice154.png'
    ...
    removeBackground(img_path, save_path)
